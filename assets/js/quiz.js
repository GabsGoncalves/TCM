...
var quizArray = [
  ...
  [
    ...
    { "Enunciado": "What is this character's name?", "Imagem": "assets/img_quiz/zote.webp", "A": "Zote", "B": "Hollow Knight", "C": "Quirrel", "D": "Lost Kim", "Gabarito": 0 },
  ...
  [
    { "Enunciado": "What area is it obtained? <br> Quicky Slash Charm", "Imagem": "", "A": "Crystal Peak", "B": "Kingdom's Edge", "C": "Greenpath", "D": "Royal Waterways", "Gabarito": 1 },
    { "Enunciado": "What area is it obtained? <br> Howling Wraiths", "Imagem": "", "A": "Mantis Village", "B": "Fungal Wastes", "C": "Fog Canyon", "D": "Queen Gardens", "Gabarito": 3 },
    { "Enunciado": "What area is it obtained? <br> Arcane Egg", "Imagem": "", "A": "Birthplace", "B": "Greepath", "C": "Fungal Wastes", "D": "Deepnest", "Gabarito": 0 },
    { "Enunciado": "What area is it obtained? <br> Isma's tear", "Imagem": "", "A": "Ancient Basin", "B": "Royal Waterways", "C": "The Hive", "D": "God Home", "Gabarito": 1 },
    { "Enunciado": "What area is it obtained? <br> King's Brand", "Imagem": "", "A": "City of Tears", "B": "Blue Lake", "C": "Kingdom's Edge", "D": "Crystal Peak", "Gabarito": 2 }
  ],
  [
...
function fimQuiz() {
  ...
  resultado.innerHTML = `<h1>CONGRATULATIONS YOU CLAIM ${geo} geo</h1> <button onclick="link('index.php')" id='voltar'>Go back</button>`;
}
